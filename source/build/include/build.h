...
static FORCE_INLINE void rotatesprite_win_alpha(int32_t sx, int32_t sy, int32_t z, int16_t a, int16_t picnum,
                                                int8_t dashade, char dapalnum, int32_t dastat, uint8_t alpha,
                                                int32_t blendidx)
{
    rotatesprite_(sx, sy, z, a, picnum, dashade, dapalnum, dastat, alpha, blendidx,
