...
float r_splitscreen_brightness = 3.f, r_splitscreen_brightnessrecip = (1.f / 3.f);
...
static int osdcmd_cvar_set_game(osdcmdptr_t parm)
{
    ...
    else if (!Bstrcasecmp(parm->name, "r_splitscreen_brightness"))
    {
        if (r_splitscreen_brightness <= 0.f)
            r_splitscreen_brightnessrecip = 1.f;
        else r_splitscreen_brightnessrecip = 1.f / r_splitscreen_brightness;
    }
...
*/
        ...
        { "r_splitscreen_brightness", "sets screen luminosity boost",(void *)&r_splitscreen_brightness, CVAR_FLOAT|CVAR_FUNCPTR, 1, 4 },
