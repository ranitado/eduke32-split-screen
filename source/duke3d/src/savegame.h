...
int32_t G_ReadSaveAddonMetadata(char const *fn);
int32_t G_ReadSaveDetailsMetadata(char const *fn, int32_t *secrets, int32_t *maxSecrets, int32_t *levelsCompleted);
